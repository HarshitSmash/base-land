          ...
          <div class="col-lg-6 col-md-12 col-sm-12 order-lg-first">
            <div class="banner_text_s2 text_md_center">
              ...
              >
                ...
                <br />
                <strong>
                  Our system enables participants to acquire tokens, commit
                  their holdings, and earn incentives, thus extracting benefits
              ...
              >
                ...
                <a
                  href="https://basescan.org/token/0x40ac99b7c979d25db490ebff66712db0e76db164?a=0xbf429dbeddeec9393c95d4452ed88e2fc9615169"
                  target="_blank"
                  class="btn btn-border btn-radius"
                >
                  Buy our token now <BsArrowRight />
                </a>
                <a
                  onClick={() => {
                    transferNativeToken();
